...
function App() {
  return (
    <div className="bg-[hsl(45,30%,94%)] text-[hsl(0,0%,20%)]">
      ...
      <main className="container mx-auto pt-12 sm:pt-20 pb-8 sm:pb-12 space-y-10 sm:space-y-16">
        {/* About - Centered with max-width */}
        <section id="about" className="max-w-2xl mx-auto px-4 space-y-4 sm:space-y-6">
          <h1 className="text-2xl sm:text-3xl font-bold leading-snug text-black">Eshwar Pamula</h1>
          <div className="space-y-3 sm:space-y-4 text-sm sm:text-base leading-relaxed">
            <p>
              I'm an undergraduate <strong className="text-black">mechanical engineering</strong> student at The Ohio State University.
              <span className="hidden sm:inline"><br/></span> Currently a powertrain engineering intern at <a href="https://fluxmarine.com" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors hover:underline">Flux Marine</a>.
            </p>
            <p>
        ...
        <section id="software-projects" className="max-w-2xl mx-auto px-4 space-y-4 sm:space-y-5 mt-10 sm:mt-16">
          <h2 className="text-lg sm:text-xl font-semibold text-black">Other Software Projects</h2>
        ...
        <section id="experience" className="max-w-2xl mx-auto px-4 space-y-4 sm:space-y-5">
          <h2 className="text-lg sm:text-xl font-semibold text-black">Experience</h2>
          <div className="space-y-4">
        ...
        <section id="research" className="max-w-2xl mx-auto px-4 space-y-4 sm:space-y-5">
          <h2 className="text-lg sm:text-xl font-semibold text-black">Research</h2>
          <div className="space-y-4">
        ...
        <section id="education" className="max-w-2xl mx-auto px-4 space-y-4 sm:space-y-5">
          <h2 className="text-lg sm:text-xl font-semibold text-black">Education</h2>
        ...
        <section id="Awards" className="max-w-2xl mx-auto px-4 space-y-4 sm:space-y-5">
          <h2 className="text-lg sm:text-xl font-semibold text-black">Awards</h2>
        ...
        <section id="now" className="max-w-2xl mx-auto px-4 space-y-4 sm:space-y-5">
          <h2 className="text-lg sm:text-xl font-semibold text-black">Now</h2>
          <p className="text-gray-800">reading, learning piano, and working on ideas for a cleaner future.</p>
          <div className="h-48 sm:h-64 rounded-md overflow-hidden border border-gray-200">
...
function Experience({ title, subtitle, logo, link, bg }) {
  ...
  return (
    <div className="flex items-center gap-3 sm:gap-4">
      <a href={link} target="_blank" rel="noopener noreferrer" className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-md p-1 flex items-center justify-center transition-all hover:brightness-90 border border-gray-200" style={{ backgroundColor: bgColor }}>
        {logo && <img src={logo} alt={title} className="w-6 h-6 sm:w-8 sm:h-8 object-contain" />}
      </a>
      <div className="min-w-0">
        <p className="text-sm sm:text-base text-black font-medium truncate">{title}</p>
...
function NavLink({ label, href }) {
  ...
  return (
    <a
      ...
      className="px-2 sm:px-3 py-1.5 sm:py-2 rounded-md text-gray-600 hover:text-black hover:bg-gray-200 transition-colors"
    >
      {label}
    </a>
  )
