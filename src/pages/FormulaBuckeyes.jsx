      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-5">
          <header className="space-y-3">
            <h1 className="text-4xl font-bold text-black">Formula Buckeyes FSAE</h1>
            <p className="text-gray-600">Suspension Design | 2022-2024</p>
          </header>
          ...
          <section className="space-y-5">
            <div className="space-y-4 text-gray-700">
              ...
              <h3 className="text-xl font-semibold text-black mt-6">My Work</h3>
              <ul className="list-disc list-inside space-y-3 ml-0 text-gray-700">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold text-black">Uprights</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold text-black">Spindles and Bearings</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold text-black">Anti-Roll Bar Design and Manufacture</h2>
